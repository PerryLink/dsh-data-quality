#!/usr/bin/env node
/**
 * Release automation for dsh-data-quality.
 *
 ...
 *      tag (message: `dsh-data-quality v<version>`).
 *
 ...
 *
 * @module dsh-data-quality/scripts/release
 */
...
git('tag', '-a', `v${version}`, '-m', `dsh-data-quality v${version}`)
